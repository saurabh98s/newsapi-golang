...
// FetchUSNewsHeadlines returns the fetched news in form of JSON
func (n *News) FetchUSNewsHeadlines(w http.ResponseWriter, r *http.Request) ([]models.Articles, error) {
	var response models.News
	...
	resp, err := http.Get("https://newsapi.org/v2/top-headlines?country=us&apiKey=29d795ddf1c040778350321158922cd3" + apiKey)
	if err != nil {
		n.l.Error(groupError + err.Error())
	}
